    ...
    for (statnb=1;statnb<5;statnb++) {
       ...
       if ((statnb==3)||(statnb==4)) {	   	   
	    ...
	    viewframe->SetLineColor(kRed);
            TGeoVolume *planes = new TGeoVolumeAssembly(nmview+"_planes");	    
	    ...
	    for (Int_t pnb=0; pnb<2; pnb++) {
	      ...
	      TGeoVolume *layers = new TGeoVolumeAssembly(nmplane+"_layers");
...
// method to get end points from TGeoNavigator
{
    ...
    prefix+=view;
    TString planes = prefix;planes+="_planes_";planes+=statnb;planes+=vnb;planes+="000000";
